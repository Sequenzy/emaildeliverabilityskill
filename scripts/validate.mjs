...
const required = [
  ...
  "public/skills/emaildeliverabilityskill/SKILL.md",
  "public/.well-known/skills/emaildeliverabilityskill/SKILL.md",
  "public/.well-known/agent-skills/emaildeliverabilityskill/SKILL.md",
...
if (!markdown.includes("npx skills add emaildeliverabilityskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "emaildeliverabilityskill") throw new Error("Invalid well-known skills index");
